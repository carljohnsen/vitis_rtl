...
# TODO der skal også være parametre, så som scalar og vectore
...
set reg [::ipx::add_register -quiet "scalar00" $addr_block]
    set_property description "Data signal of scalar00" $reg
    set_property address_offset 0x10 $reg
    set_property size 32 $reg
    #set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg]
set reg [::ipx::add_register -quiet "axi00_ptr0" $addr_block]
    set_property description "Data signal of axi00_ptr0" $reg
